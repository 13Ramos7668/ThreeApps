...
function chooseMp3OrOgg(file_name){
    ...
    if( supportsMp3() ){
        // below: yes worky
        /*
        url = "https://googledrive.com/host/0B4HC-e3WTADpfndhQkpFWDY0NUxhRDZlRzVYcmF6aE9hSG9GOWtPSmdXUEF1NV9zYmhha0k/music/" + file_name + ".mp3";
        */
        url = "http://tinyurl.com/3AppsRamos/music/" +
        file_name +
        ".mp3";        
          audioPlayer.src = url;
        ...
        //below: yes worky
        /*
        url = "https://googledrive.com/host/0B4HC-e3WTADpfndhQkpFWDY0NUxhRDZlRzVYcmF6aE9hSG9GOWtPSmdXUEF1NV9zYmhha0k/music/" + file_name + ".ogg";
        */
        url = "http://tinyurl.com/3AppsRamos/music/" +
        file_name +
        ".ogg";         
